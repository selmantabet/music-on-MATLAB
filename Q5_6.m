...
% Task 1 - Question 5 and 6

% In Question 5, we generate the same sound wave embedded with an echo
% effect "a" times the amplitude of the original signal. See echoeffect()
% helper function for this.
%
% In Question 6, we applyed an echo using the helper function echoeffect(),
% with an attenuation factor a = 0.65 and a time delay = 0.5 seconds
...
[y,Fs] =audioread('musicalnote.wav');

shifted = echoeffect(0.65,0.5,y,Fs); %Using the helper function echoeffect() to produce this echo effect.
%plays the echoed musical note
sound(shifted)

%Selmane Tabet & 724009589
%Kenana Dalle & 725002949
%MATLAB Project Task1 1 - Question 5 and 6.
